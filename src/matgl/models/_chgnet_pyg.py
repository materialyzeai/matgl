"""Implementation of the Crystal Hamiltonian Graph neural Network (CHGNet) model — PyG backend.
...
from matgl.graph._compute_pyg import (
    ...
    compute_theta_pyg,
    create_directed_line_graph_pyg,
)
...
# Extend default elements with Po, At, Rn, Fr, Ra (same as DGL version)
