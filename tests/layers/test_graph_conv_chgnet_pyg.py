...
# ---------------------------------------------------------------------------
# create_directed_line_graph_pyg + compute_theta_pyg
# ---------------------------------------------------------------------------
...
class TestLineGraphConstruction:
    ...
    def test_compute_theta_shape(self, toy_graph):
        ...
        lg_ei, lg_bvec, _, _, lg_sign = create_directed_line_graph_pyg(
            edge_index, pbc_offset, bond_vec, bond_dist, threebody_cutoff=3.0
        )
        if lg_ei.size(1) > 0:
    ...
    def test_theta_values_in_range(self):
        ...
        cos_theta = compute_theta_pyg(bond_vec, bond_sign, lg_src, lg_dst)
